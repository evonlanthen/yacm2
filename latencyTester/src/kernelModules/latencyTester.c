...
MODULE_DESCRIPTION("Latency tester");

#define MODULE_LABEL "LatencyTester"
...
static int isLatencyTesterDeviceSetUp = 0;
...
static int close(struct rtdm_dev_context *context, rtdm_user_info_t *userInfo) {
	struct timespec diff = timeDiff(startTime, stopTime);
